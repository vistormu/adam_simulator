...
class CollisionChecker:
    ...
    def get(geometry_1_id_list: np.ndarray, geometry_2_id_list: np.ndarray) -> Collision:
        ...
        shoulder_collision_list = collision_pair_list[collision_pair_list[:, 0] == 'left_shoulder', 1].tolist()
        upper_arm_collision_list = collision_pair_list[collision_pair_list[:, 0] == 'left_upper_arm', 1].tolist()
        forearm_collision_list = collision_pair_list[collision_pair_list[:, 0] == 'left_forearm', 1].tolist()
        wrist_1_collision_list = collision_pair_list[collision_pair_list[:, 0] == 'left_wrist_1', 1].tolist()
        wrist_2_collision_list = collision_pair_list[collision_pair_list[:, 0] == 'left_wrist_2', 1].tolist()
        wrist_3_collision_list = collision_pair_list[collision_pair_list[:, 0] == 'left_wrist_3', 1].tolist()
